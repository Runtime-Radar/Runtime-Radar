...
func (p *DetectorPlugin) Load(ctx context.Context, pluginPath string) (detector, error) {
...
func (p *DetectorPlugin) LoadBinary(ctx context.Context, pluginBinary []byte) (detector, error) {
