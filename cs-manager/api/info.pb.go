...
const file_info_proto_rawDesc = "" +
	...
	"\x03URL\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url2\xbe\x01\n" +
	...
	"\x0fGetCentralCSURL\x12\x16.google.protobuf.Empty\x1a\t.info.URL\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v1/info/central-cs-urlB\x18\x92A\x0e\x12\f\n" +
...
var file_info_proto_depIdxs = []int32{
	...
	0, // 2: info.InfoController.GetVersion:output_type -> info.Version
	1, // 3: info.InfoController.GetCentralCSURL:output_type -> info.URL
